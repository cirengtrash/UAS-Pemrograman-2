 ...
 * @author User
 */
public class Latihan_Exception_Handling extends javax.swing.JFrame {

    /**
     * Creates new form Latihan_Exception_Handling
     */
    public Latihan_Exception_Handling() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        setTitle("Rizqie Agung Pangestu - Exception Handling");
        setResizable(false);
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(layout.createSequentialGroup()
                        .addComponent(txtInput, javax.swing.GroupLayout.PREFERRED_SIZE, 248, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addGap(18, 18, 18)
        ...
        if (!radioException.isSelected() && !radioNoException.isSelected()) {
            ...
            if (radioException.isSelected()) {
                try {
                    ...
                    if (!isText(inputText)) {
                        throw new Exception("Input Harus Berupa Teks!");
                    } else {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Latihan_Exception_Handling.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Latihan_Exception_Handling().setVisible(true);
            }
        });
    }
